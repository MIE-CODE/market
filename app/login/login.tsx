...
const Loginpage = (props: { hideModal(): void }) => {
        ...
        <div className=" flex  items-center bg-gradient-to-br from-slate-300 to-slate-500 flex-col  shadow-2xl border-[10px]   border-teal-950 w-[800px] h-[800px] rounded-xl ">
          <div className="flex justify-center">
            ...
            <button
              ...
              className="fixed ml-[700px] mb-[60px] place-self-end text-white font-extrabold text-3xl"
            >
              x
            </button>
          </div>
          <div className="flex-col ">
            <form action="post" className="flex  flex-col   gap-3">
              ...
              <button className="transition ease-in-out hover:transition-colors hover:ease-in-out hover:delay-150 delay-150 hover:-translate-y-1 ml-[200px] mt-5 bg-yellow-900 hover:bg-gradient-to-br hover:from-yellow-800 hover:to-yellow-600 w-[200px] h-10 rounded-lg">
                Login
              </button>
            ...
            <div className=" grid mt-10  gap-5  ">
              <div className=" flex hover:border-gray-500  justify-center rounded h-12 items-center border ">
